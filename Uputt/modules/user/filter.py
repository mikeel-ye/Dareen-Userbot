...
from .help import *
from Uputt  import *
from Uputt.helpers.filter import *

@Client.on_message(filters.me & filters.command("adfil", cmd))
...
@Client.on_message(filters.me & filters.command("filters", cmd))
async def get_filterss(client: Client, message: Message):
    user_id = client.me.id
    chat_id = message.chat.id
...
@Client.on_message(filters.me & filters.command("stfil", cmd))
...
async def filters_re(client: Client, message: Message):
